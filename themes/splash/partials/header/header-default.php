...
<div class="stm-header <?php echo esc_attr($transparent_header); ?> <?php echo esc_attr($header_position); ?>">
			...
			<div class="inner">
				<div class="stm-top clearfix">
					<div class="stm-switcher pull-left">
						<?php get_template_part('partials/header/top-bar-switcher-mobile'); ?>
					</div>
