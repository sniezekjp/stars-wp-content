...
?>
	<div class="stm-media-tabs stm-news-tabs-wrapper">
		...
		<div class="tab-content">
			<?php $counter = 0; ?>
			<?php foreach($post_categories as $post_category): $counter++; ?>
				<div role="tabpanel" class="tab-pane fade <?php if($counter == 1){ ?>in active<?php } ?>" id="<?php echo esc_attr($post_category); ?>">
					<?php /*Create query*/
					$post_args = array(
						'post_type' => 'post',
						'post_status' => 'publish',
					...
					if($post_query->have_posts()): ?>
						<div class="row row-3 row-sm-2">
							<?php while($post_query->have_posts()): $post_query->the_post(); ?>
								...
								<?php get_template_part('partials/loop/content-grid'); ?>
