...
<table class="shop_table shop_table_responsive cart heading-font" cellspacing="0">
	<thead>
		<tr>
			<th class="product-thumbnail"><?php esc_html_e( 'Product', 'splash' ); ?></th>
			<th class="product-name"><?php esc_html_e( 'Name', 'splash' ); ?></th>
			...
			<td colspan="6" class="actions">
				...
				<?php if ( wc_coupons_enabled() ) { ?>
					<div class="coupon">
						...
						<label for="coupon_code"><?php esc_html_e( 'Coupon', 'splash' ); ?>:</label> <input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'splash' ); ?>" /> <input type="submit" class="button" name="apply_coupon" value="<?php esc_attr_e( 'Apply Coupon', 'splash' ); ?>" />
